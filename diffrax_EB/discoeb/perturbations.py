...
from .diffrax.rodas5generic import Rodas5Generic
from .diffrax.rodas5transformed import Rodas5Transformed
...
def evolve_one_mode( *, tau_max, tau_out, param, kmode, 
    ...
    def DEsolve_implicit( *, model, t0, t1, y0, saveat, kmode ):
        return drx.diffeqsolve(
            terms=model,
            solver=Kvaerno5(),#Rodas5Transformed(),#Rodas5(),#Rodas5Generic(),
            t0=t0,
            t1=t1,
